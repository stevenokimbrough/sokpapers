...
to setup
  ...
  create-turtles num-turtles [
    ...
    set exemplars1  []
    repeat num-exemplars [ set exemplars1 lput (random-normal damean dasd) exemplars1
    ]
    set exemplars1-mean mean exemplars1
    set exemplars1-sd standard-deviation exemplars1

  ]
  set meanmeaninitv meanmean
...
to go
  ...
  ask one-of turtles [
    let vowel one-of ["vowel" "vowel1"]
    let utterance  0
    ifelse vowel = "vowel"
    [set utterance random-normal exemplars-mean exemplars-sd]
...
;    if random-float 1 <= mirrored-positive-logistic(distance-value)(k)
    ask hearer [ifelse vowel = "vowel"
      ;;;; if
      [let d1 abs (utterance - exemplars-mean)
        let d2 abs (utterance - exemplars1-mean)
        let prob-keep 1 - (d1 / (d1 + d2))
      if random-float 1 <= prob-keep
    ...
    set exemplars-sd standard-deviation exemplars]
      ...
      [let d1 abs (utterance - exemplars1-mean)
        let d2 abs (utterance - exemplars-mean)
        let prob-keep 1 - (d1 / (d1 + d2))
