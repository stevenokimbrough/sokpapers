...
to setup
  ...
  let x py:runresult (word "random.normalvariate(" 0 "," 1.5 ")")
  print (word "In setup " x)
  create-turtles num-turtles [
    setxy random-xcor random-ycor
    set exemplars  []
    repeat num-exemplars [ set exemplars lput drawnormal(damean)(dasd) exemplars
    ]
...
to go
  ifelse influencers and ticks mod influencer-rate = 0
  [ask one-of turtles [set exemplars lput drawnormal(10)(dasd) exemplars
    set exemplars but-first exemplars]
  ]
  [
  ask one-of turtles [
    let utterance drawnormal(exemplars-mean)(exemplars-sd) ;random-normal exemplars-mean exemplars-sd
...
to-report meansd
  report mean [exemplars-sd] of turtles
end

to-report meanmean
  report mean [exemplars-mean] of turtles
end

to-report drawnormal [mu sd]
  ;;report random-normal mu sd
  report py:runresult (word "random.normalvariate(" mu "," sd ")")
end
@#$#@#$#@
GRAPHICS-WINDOW
210
...
"" ""
PENS
"meanmean" 1.0 0 -16777216 true "" "plot mean [exemplars-mean] of turtles"
"meansd" 1.0 0 -2674135 true "" "plot mean [exemplars-sd] of turtles"
...
502
NIL
mean [standard-deviation exemplars] of turtles with [xcor <= 0]
4
1
11
